...
from PyQt4.QtChart import QAreaSeries, QChart, QChartView, QLineSeries
from PyQt4.QtCore import QPointF
from PyQt4.QtGui import (QApplication, QColor, QGradient, QLinearGradient,
        QMainWindow, QPainter, QPen)
