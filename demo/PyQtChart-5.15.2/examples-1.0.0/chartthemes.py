...
from PyQt4.QtChart import (QAreaSeries, QBarSet, QChart, QChartView,
        QLineSeries, QPieSeries, QScatterSeries, QSplineSeries,
        QStackedBarSeries)
from PyQt4.QtCore import pyqtSlot, QPointF, Qt
from PyQt4.QtGui import (QCheckBox, QColor, QComboBox, QGridLayout,
        QHBoxLayout, QLabel, QPainter, QPalette, QSizePolicy, QWidget)
